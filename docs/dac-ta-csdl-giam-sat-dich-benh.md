...
- **Thông tư 06/2026/TT-BYT** — mã hóa bệnh tật, nguyên nhân tử vong theo **ICD-10** (mã bệnh truyền nhiễm, không lây nhiễm, rối loạn tâm thần, nguyên nhân thương tích).
- **Quyết định 19/2025/QĐ-TTg** — mã đơn vị hành chính (mô hình 2 cấp tỉnh/xã, hiệu lực 01/7/2025).
- **Quyết định 4210/QĐ-BYT** — bộ danh mục chuẩn ngành y tế (mã giới tính, dân tộc, quốc gia).
...
|---|---|---|---|
| id | BIGINT | PK | |
| ma_dia_ban | VARCHAR(10) | UQ, NN | Mã ĐVHC theo **QĐ 19/2025/QĐ-TTg** — tỉnh 2 chữ số (01–99), xã 5 chữ số (00001–99999) |
| ten_dia_ban | VARCHAR(200) | NN | Tên xã/phường/đặc khu hoặc tỉnh/thành phố |
| cap | VARCHAR(10) | NN | `xa` \| `tinh` (mô hình chính quyền 2 cấp, không còn cấp huyện) |
| dia_ban_cha_id | BIGINT | FK→ chính bảng | Tỉnh cha (nếu cấp = xã) |

> **CHUẨN MÃ:** Quyết định 19/2025/QĐ-TTg — Bảng danh mục và mã số các đơn vị hành chính Việt Nam (hiệu lực 01/7/2025; 34 tỉnh, 3.321 xã; Cục Thống kê – Bộ Tài chính quản lý).
...
| so_dinh_danh_ca_nhan | VARCHAR(12) | UQ | Số định danh cá nhân 12 chữ số (Luật Căn cước 2023); người chưa có dùng hộ chiếu | Mẫu 01 PL I |
| ma_dinh_danh_y_te | VARCHAR(20) | UQ | Mã định danh y tế = số định danh cá nhân | QĐ 2153/QĐ-BYT |
| ngay_sinh | DATE | | Có thể chỉ có năm sinh | |
| gioi_tinh | CHAR(1) | CHECK IN('1','2','3') | **1=Nam, 2=Nữ, 3=Chưa xác định** (QĐ 4210/QĐ-BYT) | Mẫu 01 PL I |
| dan_toc_id | BIGINT | FK→dm_dan_toc | Mã dân tộc 2 chữ số (54 dân tộc, QĐ 4210/QĐ-BYT) | |
| quoc_tich | CHAR(3) | | Mã quốc gia ISO 3166-1 alpha-3 / QĐ 4210 (vd VNM) | Mẫu 01 PL I |
...
## PHẦN J. CHUẨN MÃ HÓA DỮ LIỆU (bảng đối chiếu mã theo chuẩn Việt Nam hiện hành)

Bảng dưới đây liệt kê mọi trường mang "mã" trong CSDL và chuẩn mã hóa Việt Nam bắt buộc áp dụng, để bảo đảm dữ liệu **liên thông được** với CSDL quốc gia về dân cư, Hệ thống thông tin giám sát trong phòng bệnh của Cục Phòng bệnh và các CSDL y tế khác.

| Trường / miền dữ liệu | Chuẩn mã hóa Việt Nam áp dụng | Cấu trúc mã | Ghi chú |
|---|---|---|---|
| `nguoi.so_dinh_danh_ca_nhan` | **Luật Căn cước 2023**; Nghị định 137/2015/NĐ-CP (sửa đổi bởi NĐ 37/2021/NĐ-CP) | 12 chữ số | Định danh cá nhân, đồng bộ CSDL quốc gia về dân cư (Bộ Công an). Là khóa liên kết chính giữa các hệ thống y tế |
| `nguoi.ma_dinh_danh_y_te` | **Quyết định 2153/QĐ-BYT** ngày 25/5/2020 | = số định danh cá nhân | Mã định danh y tế (ID-Y tế) dùng chung toàn ngành y tế |
| `nguoi.gioi_tinh` | **Quyết định 4210/QĐ-BYT** (bảng danh mục GIOITINH) | 1 = Nam; 2 = Nữ; 3 = Chưa xác định | Mẫu 01 PL I QĐ97 hiển thị "Nam/Nữ/Không xác định" → ánh xạ mã 1/2/3 |
| `nguoi.dan_toc_id` → `dm_dan_toc.ma_dan_toc` | **Quyết định 4210/QĐ-BYT** (bảng DANTOC) / Danh mục thành phần dân tộc VN — Tổng cục Thống kê | 2 chữ số (vd 01 = Kinh) | 54 dân tộc |
| `nguoi.quoc_tich` | **Quyết định 4210/QĐ-BYT** (bảng QUOCGIA) / ISO 3166-1 alpha-3 | 3 ký tự chữ (vd VNM) | Mã quốc gia/quốc tịch |
| `dm_dia_ban_hanh_chinh.ma_dia_ban` (tỉnh, xã) | **Quyết định 19/2025/QĐ-TTg** — Bảng danh mục và mã số các đơn vị hành chính VN (hiệu lực 01/7/2025) | Tỉnh: 2 chữ số (01–99); Xã: 5 chữ số (00001–99999) | Mô hình chính quyền 2 cấp (34 tỉnh, 3.321 xã); Cục Thống kê (Bộ Tài chính) quản lý. **Không còn cấp huyện** |
| `dm_don_vi.ma_don_vi` (cơ sở KCB) | **Quyết định 5937/QĐ-BYT** ngày 30/12/2021 (mã cơ sở KCB dùng chung) | Mã do Bộ Y tế cấp | Áp dụng cho TYT xã, CSKCB, cơ sở xét nghiệm... |
| `dm_benh_truyen_nhiem` (mã ICD-10) | **Thông tư 06/2026/TT-BYT** ngày 02/4/2026 (mã hóa bệnh tật, nguyên nhân tử vong theo ICD-10) | ICD-10 (vd A80, A20, J09, B05...) | 46 bệnh theo Danh mục 01 PL I QĐ97. Bệnh chưa có mã ICD-10 vẫn báo cáo trực tiếp trên Hệ thống (ghi chú Danh mục 01) |
| `dm_benh_khong_lay_nhiem` (mã ICD-10) | **Thông tư 06/2026/TT-BYT** | ICD-10 dạng khoảng (vd I10–I15 THA, E10–E14 ĐTĐ, C00–C97 ung thư) | 25 bệnh — Mục I.1 PL II QĐ97 |
| `dm_roi_loan_tam_than` (mã ICD-10) | **Thông tư 06/2026/TT-BYT** (chương F) | ICD-10 chương F (vd F20, F32–F33, F00–F03) | 14 rối loạn — Mục I.2 PL II QĐ97 |
| `dm_nguyen_nhan_thuong_tich` (mã ICD-10) | **Thông tư 06/2026/TT-BYT** — ICD-10 chương XX (Nguyên nhân ngoại sinh V01–Y98) | V01–V99, W00–W99, X00–X84, X85–Y09... | 13 nguyên nhân — khớp đúng mã tại Mẫu 08–13 PL IV QĐ97 (đã đối chiếu) |
| `dm_nghe_nghiep` | 8 nhóm chuyên biệt cho giám sát thương tích | mã 1–8 | Cột 7 Mẫu 01/02 PL IV QĐ97 (không dùng Danh mục nghề nghiệp chi tiết QĐ 34/2020/QĐ-TTg vì mẫu QĐ97 phân tổ theo 8 nhóm) |
| Nhóm bệnh truyền nhiễm A/B/C | **Điều 15 + Phụ lục I TT15/2026/TT-BYT** | A / B / C | Tính theo tổng điểm 4 tiêu chí (xem quy tắc G.1) |
| Kỳ hạn báo cáo ca bệnh | **Danh mục 01 PL I QĐ97** | 24h / 48h / tuần | |
| Các enum nghiệp vụ khác (loại đối tượng, kết quả XN, mức độ thương tích, cấp độ PTDS...) | Trích trực tiếp từ TT15/2026/TT-BYT và QĐ97 | (xem cột "Danh sách giá trị" từng trường) | Không tự đặt mã ngoài văn bản |

**Kết luận rà soát mã:**
1. **Mã ICD-10** (bệnh truyền nhiễm/không lây nhiễm/rối loạn tâm thần/nguyên nhân thương tích–tử vong): đã đối chiếu với bản gốc QĐ97 — **khớp đúng**, và được chuẩn hóa theo Thông tư 06/2026/TT-BYT (đúng chuẩn ICD-10 hiện hành của Bộ Y tế).
2. **Mã đơn vị hành chính**: đã cập nhật sang **Quyết định 19/2025/QĐ-TTg** (mô hình 2 cấp tỉnh/xã, bỏ cấp huyện) — đúng chuẩn áp dụng từ 01/7/2025, phù hợp với việc TT15 chỉ quy định cấp xã/cấp tỉnh.
3. **Mã giới tính/dân tộc/quốc gia**: đã trỏ về **Quyết định 4210/QĐ-BYT** — bộ danh mục chuẩn dùng chung của ngành y tế, bảo đảm liên thông với hồ sơ sức khỏe điện tử và dữ liệu BHYT.
4. **Số định danh cá nhân**: 12 chữ số theo Luật Căn cước 2023, đồng thời là **mã định danh y tế** (QĐ 2153/QĐ-BYT) — đúng chuẩn để liên thông CSDL quốc gia về dân cư.
